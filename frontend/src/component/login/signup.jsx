...
export const Signup = () => {
  ...
  const [error, setError] = useState(null); // Optional: for error display
  ...
  return (
    <div className="bg-gray-100 flex flex-col justify-center items-center min-h-screen">
      <div className="bg-white flex flex-col items-center justify-center min-h-[600px] h-screen sm:h-auto text-black shadow-2xl mt-0 px-2 sm:px-8 rounded-none sm:rounded-xl w-full sm:max-w-md mx-auto">
        <img
          src={lensifyImg}
          alt="Lensify logo"
        ...
        >
          <div className="flex flex-row w-full gap-4">
            <div className="relative w-1/2">
              <input
                ...
                placeholder=" "
                required
                className="block px-4 pb-1.5 pt-3 w-full text-md text-black rounded-lg border border-gray-300 appearance-none focus:outline-none focus:ring-1 focus:border-black peer"
              />
              <label
                htmlFor="firstName"
                className="ml-5 absolute text-md text-black duration-300 transform -translate-y-4 scale-80 top-1 z-10 origin-[0] bg-white px-1
           peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-2.5 peer-focus:scale-80 peer-focus:-translate-y-4 left-2.5"
              >
                First Name
              </label>
            </div>
          ...
          <h4 className="mt-4 mb-4 w-full max-w-xs mx-auto text-center text-gray-600 text-sm font-normal">
